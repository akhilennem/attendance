...
//  Details details;
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    Details details=new Details(signUpRequest.getEmail(),signUpRequest.getName(),signUpRequest.getPhone()
            ,signUpRequest.getAddress(),signUpRequest.getDesignation(),signUpRequest.getBatch());
